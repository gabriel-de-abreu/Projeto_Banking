            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtConta" runat="server" CssClass="form-control" TextMode="Number" min="3"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label>Valor</label>
                        <asp:TextBox ID="txtValor" runat="server" CssClass="form-control" TextMode="Number" step="0.01" min="0.01"></asp:TextBox>
                    </div>
